...
function OpenMindSuccess({
 ...
 return (
 <div className="relative min-h-screen w-full overflow-x-hidden bg-[#f6f2f0] transition-colors duration-500 print:bg-white print:min-h-0">
 ...
 */
 ...
 const isAdminScreen = ["kelola-oprec", "dashboard-pendaftar", "kelola-anggota", "kelola-jadwal"].includes(screen);
 if (isAdminScreen && role !== "admin") {
 // Jika user biasa mencoba akses lewat manipulasi state, paksa kembali ke dashboard
 ...
 {screen === "profil-user" && (
 <div className="relative min-h-screen w-full overflow-x-hidden bg-[#f6f2f0] transition-colors duration-500">
 <GlassBackground />
 <Navbar onNavigate={navigate} onSection={() => {}} />
 <div className="relative z-10 mx-auto w-full max-w-3xl px-4 pb-24 pt-32">
 <button
 onClick={() => navigate("dashboard-user")}
 className="mb-6 inline-flex items-center gap-1.5 text-[14px] font-medium text-[#5a504b] transition hover:text-[#2a2320] :text-zinc-50"
 >
 ← Kembali
 </button>
