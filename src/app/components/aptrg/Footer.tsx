...
export function Footer() {
  return (
    <footer className="relative z-10 mx-auto mt-24 w-full max-w-6xl px-4 pb-10">
      <div className="relative overflow-hidden rounded-[18px] border border-white/60 dark:border-white/10 bg-white/70 dark:bg-zinc-900/60 px-8 py-10 backdrop-blur-xl shadow-[0_10px_40px_-14px_rgba(80,40,40,0.25)] dark:shadow-md dark:shadow-black/50 transition-colors duration-500">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            <Logo />
            <p className="mt-4 max-w-xs text-[14px] leading-relaxed text-[#857a75] dark:text-zinc-400">
              Aeromodelling & Payload Telemetry Research Group — laboratorium riset
              UAV/drone tingkat universitas.
            </p>
          </div>
          <div>
            <h4 className="mb-3 text-[#2a2320] dark:text-zinc-50">Kontak</h4>
            <ul className="space-y-2.5 text-[14px] text-[#5a504b] dark:text-zinc-400">
          ...
          <div>
            <h4 className="mb-3 text-[#2a2320] dark:text-zinc-50">Open Recruitment 2026</h4>
            <p className="text-[14px] leading-relaxed text-[#857a75] dark:text-zinc-400">
              Pendaftaran dibuka untuk seluruh mahasiswa aktif. Ikuti setiap tahapan
              seleksi hingga onboarding magang di laboratorium.
            </p>
          </div>
        </div>
        <div className="mt-8 border-t border-white/60 dark:border-white/10 pt-5 text-[13px] text-[#857a75] dark:text-zinc-500">
