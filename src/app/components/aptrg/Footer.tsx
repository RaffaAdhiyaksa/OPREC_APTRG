...
export function Footer() {
 ...
 <div className="relative overflow-hidden rounded-[18px] border border-white/60 bg-white/70 px-8 py-10 backdrop-blur-xl shadow-[0_10px_40px_-14px_rgba(80,40,40,0.25)] transition-colors duration-500">
