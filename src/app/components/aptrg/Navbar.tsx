          ...
          {user ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-[#f6f2f0] dark:bg-zinc-800 text-[13px] font-bold text-[#2a2320] dark:text-zinc-50 shadow-sm transition hover:bg-[#e0dcd9] dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-[#c81e2c]"
              >
                {initials}
              </button>
