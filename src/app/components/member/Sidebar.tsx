...
export function Sidebar({
 ...
 >
 <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/50 bg-white/75 backdrop-blur-2xl shadow-[0_2px_16px_-4px_rgba(0,0,0,0.06),0_0_0_1px_rgba(0,0,0,0.03)] transition-colors duration-500">
 {role === "admin" && (
 ...
 />
 <div className="absolute inset-0 bg-white/50 backdrop-blur-[1px] transition-colors duration-500" />
 </div>
 )}
 <div className="relative z-10 pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent transition-colors duration-500" />
 ...
 className={`relative flex w-full items-center gap-3 rounded-xl px-3.5 py-2.5 text-[14px] font-medium transition-all duration-300 ease-in-out hover:bg-white/60 :bg-white/10 ${isActive ? "text-[#1a1614] bg-red-600/10" : "text-[#6b6460] "}`}
 >
 {isActive && (
 <span
 ...
 <item.Icon
 className={`h-[18px] w-[18px] ${isActive ? "text-[#c81e2c]" : "text-[#857a75] "}`}
 />
 {item.label}
 </button>
 );
 ...
 className="flex flex-1 items-center gap-3 rounded-xl px-3.5 py-2.5 text-[14px] font-medium text-[#6b6460] transition-all duration-300 hover:bg-white/60 :bg-white/10"
 >
 ...
 className="flex flex-none items-center justify-center rounded-xl px-3 py-2.5 text-[#857a75] transition-all duration-300 hover:bg-red-50/80 :bg-red-500/20 hover:text-[#c81e2c]"
 >
