...
export function MemberLayout({
 ...
 return (
 <div className="relative min-h-screen w-full bg-[#f6f2f0] transition-colors duration-500">
 ...
 <div className="relative flex items-center justify-between gap-4 overflow-hidden rounded-2xl border border-white/50 bg-white/75 px-5 py-4 backdrop-blur-2xl shadow-[0_2px_16px_-4px_rgba(0,0,0,0.06),0_0_0_1px_rgba(0,0,0,0.03)] transition-colors duration-500 md:px-6">
 ...
 <h1 className="truncate text-[18px] font-extrabold tracking-tight text-[#2a2320] transition-colors duration-500 md:text-xl">
 {title}
 </h1>
 <p className="truncate text-[12px] font-medium text-[#857a75] transition-colors duration-500 md:text-sm">
 {subtitle}
 </p>
 </div>
 </div>
 ...
 <div className="text-[11px] font-bold uppercase tracking-widest text-[#c81e2c] transition-colors duration-500">
 {me?.label}
 </div>
 </div>
 </div>
